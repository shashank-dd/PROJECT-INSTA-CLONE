...
// },[])
    ...
    return<>
        <form>
        <div className="s"><input className="i" type="file" name="image" placeholder="No file choosen" onChange={(e)=>{
    ...
    <Link to="/postview"> <button onClick={fop} type="submit" >POST </button></Link>
